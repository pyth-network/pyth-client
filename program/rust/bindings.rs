...
pub const PRICE_T_EXPO_OFFSET: size_t = 20;
pub const PRICE_T_TIMESTAMP_OFFSET: size_t = 96;
pub const PRICE_T_AGGREGATE_OFFSET: size_t = 208;
pub const PRICE_T_AGGREGATE_CONF_OFFSET: size_t = 216;
pub const PRICE_T_AGGREGATE_PRICE_OFFSET: size_t = 208;
pub const PRICE_T_AGGREGATE_STATUS_OFFSET: size_t = 224;
pub const PRICE_T_PREV_TIMESTAMP_OFFSET: size_t = 200;
pub const PRICE_T_PREV_CONF_OFFSET: size_t = 192;
pub const PRICE_T_PREV_AGGREGATE_OFFSET: size_t = 184;
