...
fxp_exp2_approx( uint64_t x ) {
  ...
  y = UINT64_C(0x00000002d6e2cc42);               /* scale 49 bout 34 bmul  - */
  y = UINT64_C(0x0000000257c0894c) + ((y*d)>>33); /* scale 46 bout 34 bmul 64 */
  y = UINT64_C(0x00000002c01421b9) + ((y*d)>>33); /* scale 43 bout 34 bmul 64 */
  y = UINT64_C(0x000000027609e3a4) + ((y*d)>>33); /* scale 40 bout 34 bmul 64 */
  y = UINT64_C(0x00000001c6b2ea70) + ((y*d)>>33); /* scale 37 bout 34 bmul 64 */
  y = UINT64_C(0x00000001ebfbce13) + ((y*d)>>32); /* scale 35 bout 34 bmul 64 */
  y = UINT64_C(0x00000002c5c8603b) + ((y*d)>>31); /* scale 34 bout 34 bmul 64 */
