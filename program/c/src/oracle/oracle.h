...
// It is set tighly to the current price account + 96 component prices + 46 bytes for cumulative sums
const uint64_t PRICE_ACCOUNT_SIZE = 3312 + 96 * sizeof( pc_price_comp_t) + 46;
